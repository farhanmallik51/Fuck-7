...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/farhanmallik51/Apprve/blob/main/Apprve.txt').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/farhanmallik51/Apprve/blob/main/Apprve.txt').text
    if id in httpCaht:
      print(fuckyoursali)
